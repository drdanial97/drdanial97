...
Currently teaching Data Science in Berlin and quietly building [reflct.io](https://reflct.io).
...
![Prompt Engineering](https://img.shields.io/badge/Prompt_Engineering-6B48FF?style=flat)

*Product & Analytics*

![Figma](https://img.shields.io/badge/Figma-F24E1E?style=flat&logo=figma&logoColor=white)
![Amplitude](https://img.shields.io/badge/Amplitude-0052CC?style=flat)
...
![A/B Testing](https://img.shields.io/badge/A%2FB_Testing-2ECC71?style=flat)
...
🏠 **PM — Otaghak** *(top-3 accommodation marketplace)* — Redesigned booking flow, AOV +7%, GMV +8%, conversion +4%

🏗️ **Technical PM — Produpt Studio** — 7 MVPs delivered, one product scaled to 70K DAU in under a year
